    ...
    return (
      <div className="dark">
        <div className="min-h-screen bg-background flex flex-col items-center justify-between px-6 py-0 overflow-hidden">
          ...
          <div
            className="w-full max-w-md rounded-[32px] p-8 flex flex-col items-center gap-4"
    ...
    <div className="dark">
      <div className="min-h-screen bg-background flex flex-col items-center justify-between px-6 py-0 overflow-hidden">
        ...
        >
          ...
          {/* Alternates — only if alternates exist */}
          {hasAlternates && (
