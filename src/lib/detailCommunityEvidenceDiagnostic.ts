...
export type OdaraDetailCommunityEvidenceTraceEntry = {
  accordCount?: number;
  approvedFragranticaRowPresent?: boolean;
  buildCommit?: string;
  ...
  collectionPreviewChipSources?: string[];
  ...
  detailFetchStatus?: 'success' | 'error' | 'exception' | 'skipped';
  fragranceBrand?: string | null;
  fragranceId?: string | null;
  fragranceName?: string | null;
  host?: string;
  intelligenceFetchAttempted?: boolean;
  intelligenceFetchError?: boolean;
  intelligenceFetchSuccess?: boolean;
  mappedCount?: number;
  origin?: string;
  path?: string;
  renderedAccordCount?: number;
  renderedAccordsSection?: boolean;
  renderedCommunitySourceLabel?: boolean;
  renderedCommunitySignalCount?: number;
  renderedCommunitySignalsSection?: boolean;
