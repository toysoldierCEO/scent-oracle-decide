...
values
  (
    ...
    'spicy-warm',
    'Scent Blend',
    'Spice is a broad scent effect built from warm, fresh, or dry spice materials rather than one single ingredient.',
    array['Pepper', 'cinnamon bark', 'clove', 'cardamom', 'nutmeg', 'ginger', 'and dry herbal warmth'],
    'Adding heat, lift, contrast, and texture to woods, ambers, gourmands, florals, and tobacco blends.',
    'Makes a fragrance feel warmer, sharper, livelier, or more textured depending on the spice style.',
    array['Amber', 'Woods', 'Vanilla', 'Tobacco', 'Rose', 'Citrus', 'Oud', 'Leather', 'Patchouli', 'Musk'],
    null,
    'medium',
    'verified_secondary',
    'Approved Odara Scent Intel copy for broad spice/spicy scent effects. Keep this user-facing as a blended effect, not one raw material.'
  ),
  (
    'amber-resin-incense',
    'Amber / Resin / Incense',
    'accord',
    'Resinous Scent Blend',
    'oud-amber',
    'Scent Blend',
    'Amber / Resin / Incense is a warm resinous scent profile built from ambered materials, balsams, dry resins, woods, and incense effects.',
    array['Warm amber', 'dry resin', 'balsamic sweetness', 'incense smoke', 'soft woods', 'and labdanum-like depth'],
    'Building rich bases, smoky warmth, resinous depth, and darker drydowns.',
    'Makes a fragrance feel warmer, deeper, smoother, and more persistent.',
    array['Labdanum', 'Benzoin', 'Olibanum', 'Myrrh', 'Vanilla', 'Patchouli', 'Sandalwood', 'Oud', 'Leather', 'Smoke'],
    null,
    'medium',
    'verified_secondary',
    'Approved Odara Scent Intel copy for the broad amber/resin/incense profile. Keep this user-facing as a blended scent profile, not one material.'
  )
...
with target_terms as (
  ...
  where slug in ('spice', 'amber-resin-incense')
),
term_aliases as (
  select 'spice'::text as slug, alias
  from unnest(array['spice', 'spices', 'spicy']::text[]) as alias
  union all
  select 'amber-resin-incense', alias
  from unnest(array['amber-resin-incense', 'amber-resin-and-incense']::text[]) as alias
),
raw_terms as (
  select
