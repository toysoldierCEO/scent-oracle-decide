...
values
  (
    ...
    'Scent Effect',
    null,
    'Mineral / Salty Scent Effect',
    'Salt is a salty scent effect used to suggest sea air, skin salt, mineral dryness, or savory brightness.',
    array['Sea salt', 'dry skin', 'mineral air', 'clean sweat', 'driftwood edges', 'and crisp savory brightness'],
    'Marine scents, summer musks, beachy woods, skin scents, and fresh mineral compositions.',
    'Adds dryness, brightness, skin texture, and a salty edge that cuts sweetness.',
    array['Marine / Aquatic', 'Fresh Aquatic', 'Mineral', 'Coconut', 'Musk', 'Cedar', 'Vetiver', 'Amber', 'Citrus', 'Fig'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Salt as a distinct salty effect kept separate from Marine / Aquatic, Fresh Aquatic, Mineral, and Ambergris.'
  ),
  (
    'metallic',
    'Metallic',
    ...
    'Scent Effect',
    null,
    'Metallic Scent Effect',
    'Metallic is an abstract scent effect used to suggest cool metal, sharp brightness, mineral coldness, or a polished edge.',
    array['Cold metal', 'clean steel', 'mineral bite', 'sharp air', 'ink-like coolness', 'and crisp brightness'],
    'Modern woods, iris blends, mineral scents, aldehydic effects, futuristic clean scents, and sharp floral contrast.',
    'Adds coldness, edge, tension, and a polished high-contrast finish.',
    array['Iris', 'Aldehydic', 'Mineral', 'Incense', 'Musk', 'Cedar', 'Vetiver', 'Rose', 'Violet Leaf', 'Black Pepper'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Metallic as a distinct abstract effect kept separate from Mineral, Aldehydic, Ozonic, and Ink.'
  ),
  (
    'ozonic',
    'Ozonic',
    ...
    'Scent Effect',
    null,
    'Airy Fresh Scent Effect',
    'Ozonic is an airy fresh scent effect used to suggest open air, clean breeze, electric freshness, or post-rain lift.',
    array['Open air', 'clean breeze', 'cool freshness', 'airy musk', 'electric air', 'and light watery brightness'],
    'Fresh scents, aquatic blends, laundry-adjacent freshness, modern musks, and clean airy structures.',
    'Adds lift, space, clean air, and a light modern freshness.',
    array['Fresh Aquatic', 'Marine / Aquatic', 'Rain', 'Musk', 'Citrus', 'Lavender', 'Mint', 'Aldehydic', 'Mineral', 'Green Notes'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Ozonic as a distinct airy fresh effect kept separate from Fresh Aquatic, Marine / Aquatic, Rain, Cotton, and Laundry.'
  ),
  (
    'rain',
    'Rain',
    ...
    'Scent Effect',
    null,
    'Watery Fresh Scent Effect',
    'Rain is a watery fresh scent effect used to suggest wet air, rainwater, damp earth edges, and clean outdoor freshness.',
    array['Rainwater', 'wet pavement', 'damp leaves', 'clean air', 'mineral wetness', 'and soft outdoor freshness'],
    'Fresh scents, green scents, aquatic blends, mineral compositions, and clean outdoor effects.',
    'Adds wetness, freshness, clarity, and a natural outdoor feeling.',
    array['Mineral', 'Ozonic', 'Green Notes', 'Violet Leaf', 'Tea', 'Cedar', 'Vetiver', 'Musk', 'Bergamot', 'Fresh Aquatic'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Rain as a distinct watery fresh effect kept separate from Petrichor, Mineral, Ozonic, Fresh Aquatic, and Marine / Aquatic.'
  )
...
term_aliases as (
  select 'salt'::text as slug, alias
  from unnest(array[
    'salt',
    'sea-salt',
    'salt-accord',
