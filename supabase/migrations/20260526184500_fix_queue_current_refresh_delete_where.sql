...
comment on function public.refresh_taxonomy_operationalization_queue_current_v1(text, text, text, uuid[]) is
  'Refreshes the fast taxonomy operationalization queue snapshot from Queue v2.5, preserving hard blockers and official-source routing while recording a rebuild audit row.';
