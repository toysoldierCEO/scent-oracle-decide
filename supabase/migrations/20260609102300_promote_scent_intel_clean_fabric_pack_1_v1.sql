...
values
  (
    ...
    'Clean Effect',
    null,
    'Clean Fabric Scent Effect',
    'Cotton is a clean fabric scent effect used to suggest dry cotton, soft washed fabric, clean towels, and airy freshness.',
    array['Fresh cotton fabric', 'clean towels', 'soft musk', 'white soap edges', 'airy dryness', 'and light powder'],
    'Clean musks, soft daily scents, office-friendly fragrances, fabric-like freshness, and gentle powdery-clean compositions.',
    'Makes a fragrance feel softer, drier, cleaner, and more fabric-like.',
    array['Musk', 'Soapy / Clean', 'Powdery', 'Aldehydic', 'Lavender', 'Iris', 'Neroli', 'Sandalwood', 'Fresh Aquatic', 'Ozonic'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Cotton as a distinct clean fabric effect kept separate from Soapy / Clean, Laundry, Musk, Powdery, Aldehydic, Fresh Aquatic, Marine / Aquatic, and Ozonic.'
  ),
  (
    'laundry',
    'Laundry',
    ...
    null,
    'Clean Fabric Scent Effect',
    'Laundry is a clean fabric scent effect used to suggest freshly washed clothes, soft detergent-like freshness, and clean fabric musk.',
    array['Fresh laundry', 'washed fabric', 'clean towels', 'soft musk', 'faint floral soap', 'and airy freshness'],
    'Clean musks, everyday fresh scents, laundry-style fragrances, polished casual wear, and safe office-friendly blends.',
    'Adds fresh-washed softness, clean projection, and a familiar polished freshness.',
    array['Musk', 'Soapy / Clean', 'Aldehydic', 'Cotton', 'Lavender', 'Neroli', 'Fresh Aquatic', 'Ozonic', 'Powdery', 'Sandalwood'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Laundry as a distinct clean fabric effect kept separate from Soapy / Clean, Cotton, Musk, Powdery, Aldehydic, Fresh Aquatic, Marine / Aquatic, and Ozonic.'
  )
...
term_aliases as (
  select 'cotton'::text as slug, alias
  from unnest(array[
    'cotton',
    'cotton-accord',
    'cotton-notes',
