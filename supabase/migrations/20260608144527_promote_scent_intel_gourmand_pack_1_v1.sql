...
values
  (
    ...
    'Gourmand Note',
    'sweet-gourmand',
    'Gourmand / Animalic Material Effect',
    'Honey is a sweet floral-animalic effect in perfume. It can smell golden, waxy, syrupy, floral, or slightly animalic depending on the formula.',
    array['Warm honey', 'beeswax', 'pollen', 'flowers', 'hay', 'and soft animalic sweetness'],
    'Enriching florals, tobacco, amber, resins, and gourmand compositions.',
    'Makes a fragrance feel thicker, warmer, sweeter, and more textured.',
    array['Rose', 'Tobacco', 'Vanilla', 'Amber', 'Orange Blossom', 'Sandalwood', 'Cinnamon', 'Chamomile', 'Musk', 'Tonka'],
    null,
    'high',
    'verified_secondary',
    'Approved Odara Scent Intel copy for Honey as a gourmand floral-animalic material effect.'
  ),
  (
    'chocolate-cacao',
    'Chocolate / Cacao',
    ...
    'Gourmand Note',
    'sweet-gourmand',
    'Gourmand Material / Cacao Effect',
    'Chocolate / Cacao is a gourmand note that can range from dry bitter cacao to creamy sweet chocolate.',
    array['Dark cocoa', 'bitter chocolate', 'roasted nuttiness', 'soft sweetness', 'and powdery warmth'],
    'Gourmands, dark ambers, patchouli blends, edible woods, and warm floral contrasts.',
    'Adds richness, depth, edible warmth, and darker sweetness.',
    array['Vanilla', 'Tonka', 'Coffee', 'Rose', 'Orange', 'Patchouli', 'Caramel', 'Almond', 'Sandalwood', 'Rum'],
    null,
    'medium-high',
    'verified_secondary',
    'Approved Odara Scent Intel copy for Chocolate / Cacao as a gourmand cacao effect.'
  ),
  (
    'almond',
    'Almond',
    ...
    'sweet-gourmand',
    'Gourmand Note',
    'Almond is a sweet nutty effect in perfume. It often leans toward marzipan, bitter almond, cherry, or soft powder rather than raw nut.',
    array['Marzipan', 'almond extract', 'bitter kernel', 'cherry-like sweetness', 'and soft powder'],
    'Gourmands, cherry notes, heliotrope-style blends, cozy ambers, and sweet floral contrasts.',
    'Adds softness, nuttiness, powder, and edible roundness.',
    array['Cherry', 'Vanilla', 'Tonka', 'Heliotrope', 'Chocolate / Cacao', 'Coffee', 'Rose', 'Musk'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Almond as a sweet nutty gourmand note.'
  ),
  (
    'caramel',
    'Caramel',
    ...
    'Caramel is a sweet gourmand effect used to suggest melted sugar, butter, cream, and toffee warmth.',
    array['Melted sugar', 'butter', 'cream', 'toffee', 'condensed milk', 'and soft burnt sweetness'],
    'Gourmands, sweet ambers, dessert-style bases, fruity sweets, and creamy florals.',
    'Adds sweetness, comfort, density, and edible warmth.',
    array['Vanilla', 'Praline', 'Coffee', 'Tonka', 'Almond', 'Chocolate / Cacao', 'Woods', 'Musk'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Caramel as a built sweet gourmand effect.'
  ),
  (
    'sugar-cotton-candy',
    'Sugar / Cotton Candy',
    ...
    'sweet-gourmand',
    'Gourmand Scent Effect',
    'Sugar / Cotton Candy is a built sweet effect used to suggest spun sugar, candy air, and caramelized sweetness.',
    array['Spun sugar', 'candy floss', 'caramelized sweetness', 'fruity syrup', 'and airy vanilla'],
    'Modern gourmands, playful fruity scents, sweet musks, and dessert-style bases.',
    'Makes a fragrance feel sweeter, fluffier, younger, and more edible.',
    array['Vanilla', 'Red Fruits', 'Praline', 'Caramel', 'Almond', 'Musk', 'Amber', 'Soft Florals'],
    null,
    'medium',
    'source_light',
    'Approved Odara Scent Intel copy for Sugar / Cotton Candy as a built sweet gourmand effect.'
  )
...
term_aliases as (
  select 'honey'::text as slug, alias
  from unnest(array[
    'honey',
    'beeswax'
  ]::text[]) as alias
  union all
  select 'chocolate-cacao', alias
  from unnest(array[
    'chocolate-cacao',
    'cacao',
    'cocoa',
  ...
  union all
  select 'sugar-cotton-candy', alias
  from unnest(array[
    'sugar-cotton-candy',
    'sugar',
    'cotton-candy',
